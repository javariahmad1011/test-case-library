...
The employee suite reflects an HRM system where data changes have downstream consequences for payroll, reporting lines, access, and historical records. Cases emphasize master-data integrity, effective dating, audit history, soft deletion, privacy, and reconciliation.

## Test Assets

| Workbook | Cases | Primary Coverage |
|---|---:|---|
| `Add_Employee.xlsx` | 12 | Employee creation, IDs, dates, departments, manager relationship, downstream eligibility |
| `Edit_Employee.xlsx` | 12 | Org changes, effective salary history, immutable keys, concurrency, audit |
| `Delete_Employee.xlsx` | 12 | Archive/delete policy, historical preservation, orphan prevention, authorization |
| `Employee_Search.xlsx` | 12 | Search/filter/export accuracy, permissions, injection resistance, performance |
